...
public class KaptchaController
{
    ...
    public ModelAndView handleRequest(HttpServletRequest request, HttpServletResponse response) throws Exception
    {
        ...
        redisSessionManager.remove(request, MemcachedSessionManager.SessionKey.CAPTCHA);
        redisSessionManager.put(request, MemcachedSessionManager.SessionKey.CAPTCHA, captext, timeOut);
